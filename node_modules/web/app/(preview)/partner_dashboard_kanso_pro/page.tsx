export default function partnerdashboardkansoproPage() {
  return (
    <>
...
<span className="font-display-xl text-headline-md text-primary tracking-tighter">Kanso Pro</span>
</div>
<div className="flex items-center gap-md px-sm py-md border-b border-surface-container-high mb-md">
<div className="w-10 h-10 rounded-full overflow-hidden shrink-0">
<img className="w-full h-full object-cover" data-alt="A close-up portrait of a professional interior architect in a well-lit modern studio setting. Soft natural light illuminates their face, conveying approachability and expertise. The aesthetic is clean, light-mode, and sophisticated, matching a premium warm minimalism style." src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=1800&q=85"/>
</div>
<div className="flex flex-col">
<span className="font-body-md text-body-md text-on-surface font-semibold">Pro User Profile</span>
...
<div>
<h1 className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface mb-xs">Welcome back, Architect.</h1>
...
{/* Metric Card 1 */}
<div className="bg-surface-container-lowest p-lg rounded-xl ambient-shadow border border-surface-container flex flex-col justify-between min-h-[140px]">
...
<div>
<div className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface">12</div>
<div className="font-label-sm text-label-sm text-on-secondary-container mt-xs flex items-center gap-xs">
...
<div>
<div className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface">8</div>
<div className="font-label-sm text-label-sm text-on-secondary-container mt-xs flex items-center gap-xs">
...
<div>
<div className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface">$24.5k</div>
<div className="font-label-sm text-label-sm text-on-secondary-container mt-xs flex items-center gap-xs">
...
<h2 className="font-headline-md text-headline-md text-on-surface">Recent Leads</h2>
...
<img className="w-full h-full object-cover" data-alt="A bright, airy living room interior featuring minimalist warm-toned furniture, a textured cream rug, and a large window letting in natural light. The style is modern architectural editorial with a calm, inviting mood." src="https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1800&q=85"/>
</div>
<div>
<h3 className="font-body-md text-body-md text-on-surface font-semibold">Sarah Jenkins</h3>
<p className="font-label-sm text-label-sm text-secondary mt-xs">Living Room & Kitchen</p>
</div>
</div>
<div className="flex gap-sm flex-wrap">
<span className="px-sm py-xs border border-outline-variant text-secondary font-label-sm text-label-sm rounded-sm">Japandi</span>
<span className="px-sm py-xs border border-outline-variant text-secondary font-label-sm text-label-sm rounded-sm">High Budget</span>
</div>
</div>
{/* Lead Item 2 */}
<div className="p-lg border-b border-surface-container hover:bg-surface-container-low transition-colors cursor-pointer flex flex-col md:flex-row gap-md items-start md:items-center justify-between">
...
<div>
<h3 className="font-body-md text-body-md text-on-surface font-semibold">Michael Chen</h3>
<p className="font-label-sm text-label-sm text-secondary mt-xs">Master Suite Remodel</p>
</div>
</div>
<div className="flex gap-sm flex-wrap">
<span className="px-sm py-xs border border-outline-variant text-secondary font-label-sm text-label-sm rounded-sm">Minimalist</span>
<span className="px-sm py-xs border border-outline-variant text-secondary font-label-sm text-label-sm rounded-sm">Medium Budget</span>
</div>
</div>
{/* Lead Item 3 */}
...
<div className="flex gap-md items-center">
<div className="w-12 h-12 rounded-full bg-surface-container flex items-center justify-center shrink-0 text-secondary">
<span className="font-headline-md text-headline-md">E</span>
</div>
<div>
<h3 className="font-body-md text-body-md text-on-surface font-semibold">Elena Rossi</h3>
<p className="font-label-sm text-label-sm text-secondary mt-xs">Home Office</p>
</div>
</div>
<div className="flex gap-sm flex-wrap">
<span className="px-sm py-xs border border-outline-variant text-secondary font-label-sm text-label-sm rounded-sm">Mid-Century</span>
...
<div className="font-body-md text-body-md text-on-surface">Initial Consultation</div>
<div className="font-label-sm text-label-sm text-secondary">Sarah Jenkins - Video Call</div>
</div>
</div>
<div className="flex gap-md">
<div className="w-16 text-right shrink-0">
...
<div className="font-body-md text-body-md text-on-surface font-semibold">Material Review</div>
<div className="font-label-sm text-label-sm text-secondary">Studio Downtown</div>
</div>
</div>
</div>
</div>
