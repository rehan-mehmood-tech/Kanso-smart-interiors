...
<Image src="/assets/images/rooms/living-room-retreat.jpg" alt="Living Room Retreat" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover group-hover:scale-105 transition-transform duration-700 ease-in-out" />
</div>
...
<article className="bg-surface-container-lowest rounded-[16px] ambient-shadow border border-outline-variant/30 overflow-hidden group cursor-pointer flex flex-col">
<div className="relative w-full h-[280px] overflow-hidden bg-surface-container-low">
<Image src="/assets/images/rooms/master-bedroom.jpg" alt="Master Bedroom" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover group-hover:scale-105 transition-transform duration-700 ease-in-out" />
</div>
<div className="p-lg flex flex-col flex-grow">
<div className="flex justify-between items-start mb-sm">
...
<Image src="/assets/images/rooms/master-bedroom.jpg" alt="Kitchen Remodel" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover group-hover:scale-105 transition-transform duration-700 ease-in-out" />
</div>
<div className="p-lg flex flex-col flex-grow">
<div className="flex justify-between items-start mb-sm">
