...
export default function yournewspacekansoPage() {
  return (
    <>
...
<button className="bg-primary text-on-primary font-label-sm text-label-sm rounded-lg px-xl py-md hover:bg-inverse-surface transition-colors duration-300 whitespace-nowrap">
                        Book a Specialist
                    </button>
</div>
...
{/* Concept Card 1 */}
<div className="bg-surface-container-lowest rounded-[16px] p-lg ambient-shadow border border-surface-dim flex flex-col transition-transform duration-500 hover:-translate-y-1">
<div className="w-full aspect-square rounded-lg overflow-hidden mb-lg">
...
<button className="border border-outline text-primary font-label-sm text-label-sm rounded-lg px-lg py-sm w-fit hover:bg-surface-container transition-colors duration-300">
                                View Details
                            </button>
</div>
{/* Concept Card 2 */}
...
<div className="sticky top-[120px] bg-surface-container-lowest rounded-[16px] p-xl ambient-shadow border border-surface-dim">
<h2 className="text-headline-md font-headline-md text-primary mb-lg border-b border-outline-variant pb-sm">Design Specs</h2>
<div className="mb-xl">
...
<button className="w-full bg-primary text-on-primary font-label-sm text-label-sm rounded-lg px-lg py-md hover:bg-inverse-surface transition-colors duration-300 flex items-center justify-center gap-sm">
...
{/* Footer */}
<footer className="bg-surface-container-lowest dark:bg-surface-container-lowest border-t border-outline-variant w-full py-xl px-gutter flex flex-col md:flex-row justify-between items-center max-w-container-max-marketing mx-auto mt-auto">
