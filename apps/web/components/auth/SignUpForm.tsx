    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="space-y-5">
        ...
        <div>
          ...
          {passwordTooShort && (
            <p className="mt-2 w-full font-body text-xs leading-relaxed text-[#ba1a1a]">
      ...
      <p className="mt-5 w-full font-body text-xs leading-relaxed text-[#1b1c19]/55">
        By signing up, you agree to our{" "}
        <Link
          href="/terms"
          className="text-[#1b1c19] underline underline-offset-4 hover:text-[#1b1c19]/65"
        >
          Terms of Service
        </Link>{" "}
        and{" "}
