...
export function OnboardPartnerModal({ isOpen, onClose }: OnboardPartnerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background/80 backdrop-blur-sm flex justify-end">
      {/* Drawer */}
      <div className="w-full max-w-[32rem] h-full bg-surface-container-lowest shadow-2xl border-l border-outline-variant/30 flex flex-col animate-in slide-in-from-right duration-300">
